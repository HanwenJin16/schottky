...
SBH_eV = getSBH(X_eV, PhiM_eV); # calculate Schottky barrier height
%SBH_eV = Eg_eV;
Vmp = getVmp(Ip, SBH_eV * el, meff*me, kT, h, el);
Vmp = getVmp2(Ip, SBH_eV * el, meff*me, kT, h, el); # calculate voltage at maximum power

eta = geteta(el * Vmp, SBH_eV * el, meff*me, kT, Pin, h);
